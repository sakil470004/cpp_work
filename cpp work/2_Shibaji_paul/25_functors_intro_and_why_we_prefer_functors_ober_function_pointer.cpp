...
public:
    criteria_functor_odd()
    {
        isRange = false;
    }
    criteria_functor_odd(int startRange, int endRange) : startRange(startRange), endRange(endRange)
    {
        isRange = true;
    }
...
public:
    criteria_functor_even()
    {
        isRange = false;
    }
    criteria_functor_even(int startRange, int endRange) : startRange(startRange), endRange(endRange)
    {
        isRange = true;
    }
